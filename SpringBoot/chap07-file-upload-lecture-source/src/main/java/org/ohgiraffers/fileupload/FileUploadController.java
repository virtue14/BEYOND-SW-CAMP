...
//        System.out.println("빌드 된 single 디렉토리의 절대경로: " + resource.getFile().getAbsoluteFile());
        String filePath = resource.getFile().getAbsolutePath();

        /* 설명: 사용자가 넘긴 파일을 확인하고, rename(자바의 UUID 클래스를 활용해서 rename) */
...
//        System.out.println("multiFileDescription = " + multiFileDescription);
        ...
        try {
            ...
            rttr.addFlashAttribute("imges", saveFiles);
            ...
            rttr.addFlashAttribute("message", "파일 업르드 실패 ㅠㅠ");
        }
