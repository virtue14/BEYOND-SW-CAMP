...
public class ResolverController {
    ...
    public String stringRedirect(Model model) {
        model.addAttribute("message1", "문장열로 뷰 이름 반환하며 리다이렉트");
    ...
    /* 설명 1. 기존에 핸들러 메소드가 'void 또는 String'으로만 반환했는데 ModelAndView를 반환하기 */
    /* 설명 2. 단순 forward 시에는 String 반환과 Model을 활용하는 코드와 ModelAndView를 활용한 코드 차이가 있다. */
