...
public class SimpleJPQLTests {
    ...
    /* 설명
        jpql의 문법
          ...
          2. INSERT는 persis() 메소드를 사용하면 된다.
          3. 키워드는 대소문자를 구문하지 않지만, 엔티티와 속성은 대소문자를 구분하므로 유의한다.
        jpql의 사용 방법은 다음과 같다.
          1. 작성한 jqpl(문자열)을 'entityManager.createQuery()' 메소드를 통해 쿼리 객체로 만든다.
    ...
    */
    ...
    @Test
    void TypedQuery를_이용한_단일행_단일열_조회_테스트() {
        ...
        assertEquals("민트미역국".strip(), resultMenuName);
    }
