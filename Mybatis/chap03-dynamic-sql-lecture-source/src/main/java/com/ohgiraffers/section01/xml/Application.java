...
public class Application {
    ...
    private static void chooseSubMenu() {
        ...
        do {
            ...
            System.out.print("1. 카테고리 상위 분류별 메뉴 보여주기(식사, 음식, 디저트)");
            System.out.print("9. 이전 메뉴");
            int no = sc.nextInt();
    ...
    /* 설명: 1부터 21까지의 5개의 중복되지 않는 번호 생성해 List에 쌓아 반환 */
    private static void trimSubMenu() {
        ...
        do {
            ...
            switch (no) {
                case 1:
                    menuService.searchMenuByCoderOrSearchAll(inputAllOrOne());
                    break;
                case 2:
    ...
    /* 설명: SearchCriteria(condition과 value의 묶음) 개념을 이번에는 DTO가 아닌 Map으로 작성 */
