...
public class Application {
    ...
    private static final String user = "swcamp";
        ...
        */
        ...
        /* 필기
             : SqlSessionFactory: SqlSession 객체를 생성하기 위한 팩토리 역할의 인터페이스
               SqlSessionBuilder: SqkSessionFactory 인터페이스 타입의 하위 구현 객체를 생성하기 위한 빌드 역할
               build(): 설정에 대한 정보를 담고 있는 Configuration 타입의 객체 혹은 외부 설정과 파일과 연결된 stream을
